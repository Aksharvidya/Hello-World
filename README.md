...
- GITHUB figures out how to intelligently merge this flow of changes, and GITHUB helps ypu manage the flow through features such as "pull requests"


PMT- Project Management Tools
GITHUB:
Created account with personal information 
GITHUB Sidebar menu:
1. Home:
    - Shows the activity from people you follow.
    - Recent repositories, notifications and updates 

2. Issues:
    - Used to report and track problems or tasks in a project.
    Eg: New feature request.
        Bug found in Code.
        Task to complete.
        
3. Pull Requests:
    Used to suggest changes to a project.
    Process : -You edit the code
              -Your request the owner to review
              - They approve and merge
   -Its how collaboration happens in GITHUB.
...
4. Repositories:
  ...
  6. Discussions:
     -Used for asking questions and general conversations about a project
     -Not for bugs
  ...
  9. Explore:
   ...
   10. Marketplace:
    ...
    11. MCP Registry:
        - Used for managing Model Context Protocol
        - Mostly used by developers working wit AI integrations.
